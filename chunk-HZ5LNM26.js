var i = (function (e) {
  ...
  c = "*";
function _(e, t) {
  return { type: i.Trigger, name: e, definitions: t, options: {} };
}
function f(e, t = null) {
  return { type: i.Animate, styles: t, timings: e };
}
function g(e, t = null) {
  return { type: i.Sequence, steps: e, options: t };
}
function d(e) {
  return { type: i.Style, styles: e, offset: null };
}
function y(e, t, s) {
  return { type: i.State, name: e, styles: t, options: s };
}
function m(e, t, s = null) {
  return { type: i.Transition, expr: e, animation: t, options: s };
}
var h = class {
    _onDoneFns = [];
    _onStartFns = [];
    ...
    triggerCallback(t) {
      let s = t == "start" ? this._onStartFns : this._onDoneFns;
  ...
  l = class {
    ...
    setPosition(t) {
      let s = t * this.totalTime;
      this.players.forEach((n) => {
        let o = n.totalTime ? Math.min(1, s / n.totalTime) : 1;
        n.setPosition(o);
      });
    }
    getPosition() {
      let t = this.players.reduce(
        (s, n) => (s === null || n.totalTime > s.totalTime ? n : s),
        null,
      );
